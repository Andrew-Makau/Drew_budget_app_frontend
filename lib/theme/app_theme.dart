...
class AppTheme {
  ...
  static const Color primaryDark =
      Color(0xFF3B82F6); // Interactive blue for dark mode
  static const Color secondaryLight = Color(0xFFF8FAFC); // Clean background
  static const Color secondaryDark = Color(0xFF1F2937); // Dark mode background
  static const Color accentLight = Color(0xFF3B82F6); // Interactive elements
  static const Color accentDark =
      Color(0xFF60A5FA); // Lighter accent for dark mode
  static const Color successLight = Color(0xFF10B981); // Biometric confirmation
